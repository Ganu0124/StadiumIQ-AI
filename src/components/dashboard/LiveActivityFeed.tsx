...
export function LiveActivityFeed() {
  return (
    <section aria-label="Operations Activity Feed" className="h-full">
      <Card variant="glass" className="h-full flex flex-col min-h-[350px]">
        ...
        <div 
          className="flex-1 overflow-y-auto mt-4 space-y-3 pr-1 max-h-[380px] focus-visible:ring-1 focus-visible:ring-primary rounded-md"
          tabIndex={0}
          aria-live="polite"
        ...
        >
          {activityFeed.map((item) => {
            ...
            return (
              <article 
                key={item.id} 
                className="flex gap-3 text-xs leading-relaxed group transition-all duration-200 hover:bg-glass/10 p-1.5 rounded-md"
                role="log"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-[9px] text-text-tertiary font-bold" aria-hidden="true">•</span>
